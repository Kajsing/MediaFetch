...
draw.rounded_rectangle((0, 0, 511, 511), radius=120, fill="#aba3ff")
for points in [[(256, 112), (256, 312)], [(176, 240), (256, 320), (336, 240)], [(144, 360), (144, 408), (368, 408), (368, 360)]]:
    draw.line(points, fill="#171328", width=40, joint="curve")
    for x, y in (points[0], points[-1]):
        draw.ellipse((x-20, y-20, x+20, y+20), fill="#171328")
