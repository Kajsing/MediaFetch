...
The integration branch is `main`, created from the merged `codex/mvp` at `4d5ff05`. It includes YouTube 0.2.0 and the Slate interface. The owner requested `main` as the GitHub default branch; the earlier feature branches remain available as history.
